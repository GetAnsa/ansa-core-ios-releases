...
SWIFT_CLASS("_TtC4core30AddPaymentMethodViewController")
...
SWIFT_CLASS("_TtC4core25CardBalanceViewController")
@interface CardBalanceViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
